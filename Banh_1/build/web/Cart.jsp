            ...
            <div class="shopping-cart">
                ...
                <div class="alert alert-success" role="alert">
				  	${mess}
                                             ...
                                             <c:forEach items="${listProduct}" var="p">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><a href="deleteCart?productID=${o.productID }" class="text-dark">
                                                            <button type="button" class="btn btn-danger" style="background-color: black; color: pink;">Delete</button>
                                                        </a>
                                                    </td>
                                                </tr> 
                                                 </c:if>
                       ...
                       <div class="row">
    <div class="col-lg-12"> <!-- Sử dụng col-lg-12 để chiếm toàn bộ chiều rộng của dòng -->
        <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold" style="text-align: center;">Total</div>
        <div class="p-4">
            <ul class="list-unstyled mb-4" id="contentTotalMoney">
                <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total Money Products</strong><strong>${totalMoney} $</strong></li>
                ...
                <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total of check out</strong>
                    <h5 class="font-weight-bold">${totalMoneyVAT} $</h5>
                </li>
            </ul>
            <a href="home" class="btn btn-dark rounded-pill py-2 btn-block" style=" color: pink;">Check out</a>
        </div>
    </div>
</div>
